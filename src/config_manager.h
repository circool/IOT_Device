 ...
 * @brief Менеджер конфигурации и параметров
...
/** @brief Использовать таймер аварийного отключения */
#ifndef FEATURE_EMERGENCY_ENABLED
#define FEATURE_EMERGENCY_ENABLED 1
#endif
...
// ----------------------------------------------------------------------------
/** @brief При наличии в каталоге файла credentials.h из него берутся значения установленных в нем параметров */
#ifdef __has_include
