...
- [Конфигурация](#-конфигурация)
  - [Настройки в коде (config.h)](#-настройки-в-коде-configh)
  - [Настройки в среде (platformio.ini)](#-настройки-в-среде-platformioini)
  - [Файл credentials.h (опционально)](#-файл-credentialsh-опционально)
...
[!NOTE]
> На многих модулях NodeMCU и ESP32-devkit на GPIO2 уже установлен встроенный синий светодиод (обычно с инверсной логикой — LOW = включён). В этом случае внешний светодиод можно не подключать, достаточно указать в `platformio.ini`:
> ```ini
> -DSTATUS_LED_PIN=2
> -DLED_INVERTED=1   # для ESP8266
> -DLED_INVERTED=0   # для ESP32
> ```
